...
const NesController::Button tetrisBindings[] = {
		NesController::Button::SELECT,
		NesController::Button::SELECT,
		NesController::Button::SELECT,
		NesController::Button::SELECT,
		NesController::Button::B,		// Rotate
		NesController::Button::LEFT,	// Left move
		NesController::Button::RIGHT,	// Right move
		NesController::Button::DOWN,	// Drop
		NesController::Button::SELECT,
		NesController::Button::SELECT,
		NesController::Button::SELECT,
		NesController::Button::SELECT,
